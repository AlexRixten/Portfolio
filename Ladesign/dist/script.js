...
/* harmony import */ var _modules_calc_2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/calc_2 */ "./src/js/modules/calc_2.js");
...
/* harmony import */ var _modules_modals__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/modals */ "./src/js/modules/modals.js");
...
/* harmony import */ var _modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/showMoreStyles */ "./src/js/modules/showMoreStyles.js");
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/sliders */ "./src/js/modules/sliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordion-heading span');
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_1__["default"])('.nav .header-link', '.burger'); // drop();
...
var burger = function burger(menuSelector, burgerSelector) {
  var menuElem = document.querySelectorAll(menuSelector),
  ...
  burgerElem.addEventListener('click', function () {
    ...
    if (burgerElem.classList.contains('active')) {
      menuElem.forEach(function (item) {
...
var calc_2 = function calc_2(state) {
  var sizeBlock = document.querySelectorAll('#size'),
...
/* harmony default export */ __webpack_exports__["default"] = (calc_2);
...
var drop = function drop() {
  // * Для перетаскивания элементов на странице
  // drag *
  // dragend *
  // dragstart *
  // dragexit *
  // Для перетаскивания элементов из файловой системы
